...
BEGIN DBMS_SCHEDULER.drop_job('T24RAWOGG.T24_LNMEMO_ACTIVITY_GEN_FROM_ACC_ECB_JOB', FALSE); END;
...
BEGIN DBMS_SCHEDULER.stop_job('T24RAWOGG.T24_LNMEMO_ACTIVITY_GEN_FROM_ACC_ECB_JOB', FALSE); END;
...
BEGIN DBMS_SCHEDULER.run_job('T24RAWOGG.T24_LNMEMO_ACTIVITY_GEN_FROM_ACC_ECB_JOB', FALSE); END;
