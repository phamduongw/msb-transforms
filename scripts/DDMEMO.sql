...
BEGIN
    T24_DDMEMO_ACTIVITY_PKG.GEN_FROM_ACC_PROC;
END;
...
SELECT * FROM T24_DDMEMO_ACTIVITY
...
UNION ALL 
SELECT 'FMSB_ARR_MAPPED', COUNT(*) FROM FMSB_ARR_MAPPED 
UNION ALL 
SELECT 'FMSB_ARC_DDMEMO', COUNT(*) FROM FMSB_ARC_DDMEMO 
UNION ALL 
SELECT 'T24_DDMEMO_ACTIVITY_ADL', COUNT(*) FROM T24_DDMEMO_ACTIVITY_ADL
UNION ALL 
SELECT 'T24_DDMEMO_ACTIVITY_ECB', COUNT(*) FROM T24_DDMEMO_ACTIVITY_ECB
UNION ALL 
SELECT 'T24_DDMEMO_ACTIVITY_ACC', COUNT(*) FROM T24_DDMEMO_ACTIVITY_ACC
UNION ALL 
SELECT 'T24_DDMEMO_ACTIVITY_ARR', COUNT(*) FROM T24_DDMEMO_ACTIVITY_ARR
UNION ALL 
SELECT 'T24_DDMEMO_ACTIVITY_LMT', COUNT(*) FROM T24_DDMEMO_ACTIVITY_LMT
UNION ALL 
SELECT 'T24_DDMEMO_ACTIVITY', COUNT(*) FROM T24_DDMEMO_ACTIVITY;