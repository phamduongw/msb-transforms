...
BEGIN
    T24_DDTNEW_ACTIVITY_PKG.GEN_FROM_ACC_PROC;
END;
...
UNION ALL 
SELECT 'T24_DDTNEW_ACTIVITY_ACC', COUNT(*) FROM T24_DDTNEW_ACTIVITY_ACC
UNION ALL 
SELECT 'T24_DDTNEW_ACTIVITY_ARR', COUNT(*) FROM T24_DDTNEW_ACTIVITY_ARR
UNION ALL 
