...
BEGIN
    T24_DDTNEW_ACTIVITY_PKG.GEN_FROM_ACC_ARR_ECB_PROC;
END;
...
SELECT * FROM T24_DDTNEW_ACTIVITY
...
UNION ALL  
SELECT 'T24_DDTNEW_ACTIVITY_ACC_ARR_ECB', COUNT(*) FROM T24_DDTNEW_ACTIVITY_ACC
UNION ALL 
SELECT 'T24_DDTNEW_ACTIVITY', COUNT(*) FROM T24_DDTNEW_ACTIVITY;