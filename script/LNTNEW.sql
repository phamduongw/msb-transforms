...
SELECT * FROM T24_LNTNEW_ACTIVITY
...
UNION ALL 
SELECT 'FMSB_AAC_MAPPED', COUNT(*) FROM FMSB_AAC_MAPPED
UNION ALL 
SELECT 'FMSB_ACC_MAPPED', COUNT(*) FROM FMSB_ACC_MAPPED
UNION ALL 
SELECT 'FMSB_AIT_LNTNEW', COUNT(*) FROM FMSB_AIT_LNTNEW 
UNION ALL 
SELECT 'FMSB_ARC_LNTNEW', COUNT(*) FROM FMSB_ARC_LNTNEW 
UNION ALL 
SELECT 'FMSB_ARR_LNTNEW', COUNT(*) FROM FMSB_ARR_LNTNEW 
UNION ALL 
SELECT 'FMSB_ASC_MAPPED', COUNT(*) FROM FMSB_ASC_MAPPED
UNION ALL 
SELECT 'FMSB_ATA_MAPPED', COUNT(*) FROM FMSB_ATA_MAPPED
UNION ALL 
SELECT 'T24_LNTNEW_ACTIVITY_ACC', COUNT(*) FROM T24_LNTNEW_ACTIVITY_ACC
UNION ALL 
SELECT 'T24_LNTNEW_ACTIVITY_ARR', COUNT(*) FROM T24_LNTNEW_ACTIVITY_ARR
UNION ALL 
SELECT 'T24_LNTNEW_ACTIVITY_AIT', COUNT(*) FROM T24_LNTNEW_ACTIVITY_AIT
UNION ALL 
SELECT 'T24_LNTNEW_ACTIVITY_ASC', COUNT(*) FROM T24_LNTNEW_ACTIVITY_ASC
UNION ALL 
SELECT 'T24_LNTNEW_ACTIVITY', COUNT(*) FROM T24DB_OGGDS.T24_LNTNEW_ACTIVITY;
