...
WHERE CHANGED_TIME
          > TO_TIMESTAMP('2025-07-14 00:00:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3')
--    BETWEEN TO_TIMESTAMP('2025-07-13 00:14:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3') AND TO_TIMESTAMP('2025-07-14 00:26:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3')
...
FROM (SELECT EXTRACT(SECOND FROM (CHANGED_TIME - REPLICAT_TS)) AS LATENCY
      FROM T24_LNMEMO_ACTIVITY
      WHERE CHANGED_TIME
                > TO_TIMESTAMP('2025-07-14 00:00:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3')
--    BETWEEN TO_TIMESTAMP('2025-07-14 00:14:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3') AND TO_TIMESTAMP('2025-07-14 00:26:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3')
--    AND EXTRACT(SECOND FROM (CHANGED_TIME - REPLICAT_TS)) > 2
     );

--SELECT BILPRN, BILINT, BILLC, CALL_CDC
SELECT *
FROM T24_LNMEMO_ACTIVITY
...
JOIN FMSB_BIL_LNMEMO BIL
  ON BIL.ARRANGEMENT_ID = ARR.RECID
GROUP BY ARR.RECID
ORDER BY CNT_BIL DESC;
