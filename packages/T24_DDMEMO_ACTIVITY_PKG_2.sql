    ...
    BEGIN
        ...
        IF V_WINDOW_ID_LIST.COUNT > 0 THEN
            ...
            SELECT
                ...
                END,
                CALC_SCCODE_VAL_FUNC(ARR.PRODUCT_STATUS, ARR.PRODUCT),
                (
            ...
            JOIN V_V_FMSB_ECB_MAPPED ECB ON ECB.RECID = ACC.RECID
            LEFT JOIN V_FMSB_ADL_MAPPED ADL ON ADL.RECID = ARR.RECID
            LEFT JOIN V_V_FMSB_LMT_MAPPED LMT ON LMT.RECID = ACC.LIMIT_KEY
