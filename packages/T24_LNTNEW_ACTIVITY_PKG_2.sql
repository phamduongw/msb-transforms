...
CREATE OR REPLACE PACKAGE BODY T24RAWOGG.T24_LNTNEW_ACTIVITY_PKG IS 
    ...
    PROCEDURE GEN_FROM_ACC_PROC IS
        ...
        V_TODAY          VARCHAR2(8);
    BEGIN
        DELETE /*+ PARALLEL(CDC, 8) */  FROM T24_LNTNEW_ACTIVITY_ACC CDC
        WHERE EXISTS (
        ...
        ARC_AGGREGATED AS (
            ...
            FROM FMSB_ARC_LNTNEW ARC
            WHERE EXISTS (
                SELECT 1
                FROM PRECOMPUTED PRE
                WHERE PRE.ARR_RECID = ARC.ARRANGEMENT
            )
            -- JOIN PRECOMPUTED PRE ON PRE.ARR_RECID = ARC.ARRANGEMENT
        ...
        ATA_AGGREGATED AS (
            ...
            -- JOIN PRECOMPUTED PRE ON PRE.ARR_RECID = ATA.ID_COMP_1
        ...
        ASC_AGGREGATED AS(
            ...
            -- JOIN PRECOMPUTED PRE ON PRE.ARR_RECID = ASCC.ID_COMP_1
            WHERE EXISTS (
                SELECT 1
                FROM PRECOMPUTED PRE
        ...
        AAC_AGGREGATED AS(
            ...
            FROM FMSB_AAC_MAPPED AAC
            -- JOIN PRECOMPUTED PRE ON PRE.ARR_RECID = AAC.ID_COMP_1
            WHERE EXISTS (
                SELECT 1
                FROM PRECOMPUTED PRE
    ...
    PROCEDURE GEN_FROM_ARR_PROC IS
        ...
        V_TODAY          VARCHAR2(8);
    BEGIN
        DELETE /*+ PARALLEL(CDC, 8) */ FROM T24_LNTNEW_ACTIVITY_ARR CDC
        WHERE EXISTS (
        ...
        ARC_AGGREGATED AS (
            ...
            FROM FMSB_ARC_LNTNEW ARC
            JOIN PRECOMPUTED PRE ON PRE.ARR_RECID = ARC.ARRANGEMENT
            WHERE EFFECTIVE_DATE <= TO_DATE(V_TODAY, 'YYYYMMDD')
            GROUP BY ARC.ARRANGEMENT
         ),
        ATA_AGGREGATED AS (
            SELECT 
    ...
    PROCEDURE GEN_FROM_AIT_PROC IS
        ...
        V_TODAY          VARCHAR2(8);
    BEGIN
        DELETE /*+ PARALLEL(CDC, 8) */ FROM T24_LNTNEW_ACTIVITY_AIT CDC
        WHERE EXISTS (
