...
---------------------------------------------------------------------------
    ...
    BEGIN
        ...
        FROM T24_CDMEMO_ACTIVITY_ACC
        WHERE ROWNUM = 1;

        DELETE /*+ PARALLEL(CDC, 8) */ FROM T24_CDMEMO_ACTIVITY_ACC CDC
        WHERE EXISTS (
            SELECT 1
...
---------------------------------------------------------------------------
    ...
    BEGIN
        SELECT 1 INTO V_DUMMY
        FROM T24_CDMEMO_ACTIVITY_ECB
        WHERE ROWNUM = 1;

        DELETE /*+ PARALLEL(CDC, 8) */ FROM T24_CDMEMO_ACTIVITY_ECB CDC
        WHERE EXISTS (
            SELECT 1
...
---------------------------------------------------------------------------
    ...
    BEGIN
        SELECT 1 INTO V_DUMMY
        FROM T24_CDMEMO_ACTIVITY_ARR
        WHERE ROWNUM = 1;

        DELETE /*+ PARALLEL(CDC, 8) */ FROM T24_CDMEMO_ACTIVITY_ARR CDC
        WHERE EXISTS (
            SELECT 1
