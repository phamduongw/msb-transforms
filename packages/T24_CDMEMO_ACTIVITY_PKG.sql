...
---------------------------------------------------------------------------
    ...
    BEGIN
        ...
        IF V_WINDOW_ID_LIST.COUNT > 0 THEN
            ...
            DELETE FROM T24_CDMEMO_ACTIVITY_ACC
...
---------------------------------------------------------------------------
    ...
    BEGIN
        ...
        IF V_WINDOW_ID_LIST.COUNT > 0 THEN
            ...
            DELETE FROM T24_CDMEMO_ACTIVITY_ECB
            WHERE WINDOW_ID MEMBER OF V_WINDOW_ID_LIST;
        END IF;
...
---------------------------------------------------------------------------
    ...
    BEGIN
        ...
        IF V_WINDOW_ID_LIST.COUNT > 0 THEN
            ...
            DELETE FROM T24_CDMEMO_ACTIVITY_ARR
            WHERE WINDOW_ID MEMBER OF V_WINDOW_ID_LIST;
        END IF;
...
---------------------------------------------------------------------------
    ...
    BEGIN
        SELECT CDC.WINDOW_ID
        BULK COLLECT INTO V_WINDOW_ID_LIST
        FROM T24_CDMEMO_ACTIVITY_ADL CDC
        WHERE EXISTS (
            SELECT 1
