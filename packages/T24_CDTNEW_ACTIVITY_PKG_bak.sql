        ...
        IF V_JOIN_KEY_LIST.COUNT > 0 THEN
            ...
            SELECT
                ...
                GREATEST(
                    ...
                    NVL(CHG.COMMIT_TS, TIMESTAMP '1991-12-07 00:00:00.000')
                ) AS COMMIT_TS,
                GREATEST(
                    ...
                    NVL(CHG.REPLICAT_TS, TIMESTAMP '1991-12-07 00:00:00.000')
                ) AS REPLICAT_TS,
                GREATEST(
                    NVL(PRE.MAPPED_TS, TIMESTAMP '1991-12-07 00:00:00.000'),
                    NVL(AIT.MAPPED_TS, TIMESTAMP '1991-12-07 00:00:00.000'),
                    NVL(ATA.MAPPED_TS, TIMESTAMP '1991-12-07 00:00:00.000'), 
                    NVL(CHG.MAPPED_TS, TIMESTAMP '1991-12-07 00:00:00.000')
                ) AS MAPPED_TS,
                'ARR_AIT_ATA_CHG'
            FROM PRECOMPUTED PRE
            LEFT JOIN AIT_AGGREGATED AIT ON AIT.ID_COMP_1   = PRE.ARR_RECID
