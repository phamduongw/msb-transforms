        ...
        IF V_JOIN_KEY_LIST.COUNT > 0 THEN
            ...
            SELECT
                ...
                GREATEST(
                    ...
                    CASE WHEN CHG.WINDOW_ID IS NOT NULL THEN CHG.WINDOW_ID END
                ) AS WINDOW_ID,
                GREATEST(
                    ...
                    CASE WHEN CHG.COMMIT_TS IS NOT NULL THEN CHG.COMMIT_TS END
                ) AS COMMIT_TS,
                GREATEST(
                    ...
                    CASE WHEN CHG.REPLICAT_TS IS NOT NULL THEN CHG.REPLICAT_TS END
                ) AS REPLICAT_TS,
                GREATEST(
                    ...
                    CASE WHEN CHG.MAPPED_TS IS NOT NULL THEN CHG.MAPPED_TS END
                ) AS MAPPED_TS,
                'ARR_AIT_ATA_CHG'
            FROM PRECOMPUTED PRE
            LEFT JOIN AIT_AGGREGATED AIT ON AIT.ID_COMP_1   = PRE.ARR_RECID
