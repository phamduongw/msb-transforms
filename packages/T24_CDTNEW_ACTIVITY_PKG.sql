    ...
    BEGIN
        ...
        IF V_JOIN_KEY_LIST.COUNT > 0 THEN
            ...
            PRECOMPUTED AS (
                ...
                FROM GROUPED GRP
                INNER JOIN  V_FMSB_ARR_CD ARR     ON ARR.RECID = V.COLUMN_VALUE
            ...
            SELECT
                ...
                TO_NUMBER(TO_CHAR(PRE.RS2DT7, 'YYYYDDD')) AS RS2DT7,
                GREATEST(ARR.WINDOW_ID, AIT.WINDOW_ID, ATA.WINDOW_ID, CHG.WINDOW_ID)         AS WINDOW_ID,
                GREATEST(ARR.COMMIT_TS, AIT.COMMIT_TS, ATA.COMMIT_TS, CHG.COMMIT_TS)         AS COMMIT_TS,
                GREATEST(ARR.REPLICAT_TS, AIT.REPLICAT_TS, ATA.REPLICAT_TS, CHG.REPLICAT_TS) AS REPLICAT_TS,
                GREATEST(ARR.MAPPED_TS, AIT.MAPPED_TS, ATA.MAPPED_TS, CHG.MAPPED_TS)         AS MAPPED_TS,
                'ARR_AIT_ATA_CHG'
            FROM PRECOMPUTED PRE
            LEFT JOIN AIT_AGGREGATED AIT ON AIT.ID_COMP_1 = PRE.ARR_RECID
            LEFT JOIN ATA_AGGREGATED ATA ON ATA.ID_COMP_1 = PRE.ARR_RECID
