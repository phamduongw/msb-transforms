...
CREATE OR REPLACE PACKAGE BODY T24RAW.T24_LNTNEW_ACTIVITY_PKG IS 
   ...
   FUNCTION CALC_IPFREQ_VAL_FUNC(
    ...
    BEGIN
        ...
        JOIN AGGREGATED AGG ON AGG.ID_COMP_1 = PRE.ARR_RECID; 
    ...
    BEGIN
        ...
        AGGREGATED AS (
            SELECT ASCC.ID_COMP_1, ASCC.CALC_AMOUNT, ASCC.BILL_TYPE, ASCC.PROPERTY, ASCC.PAYMENT_FREQ
            FROM FMSB_ASC_MAPPED ASCC
            WHERE EXISTS (
                SELECT 1 FROM PRECOMPUTED PRE
