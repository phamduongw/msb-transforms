    ...
    BEGIN
	  ...
	  SELECT CDC.WINDOW_ID
        ...
        END TMTXAMT,
                ...
                'POR'
            FROM TABLE(V_WINDOW_ID_LIST) V
            join t24raw.F_POR_TMTRAN por on por.WINDOW_ID = V.COLUMN_VALUE
